...
public enum LevelDef {
    ...
    CHAPTER1_LEVEL3(1, 3,
        ...
        new int[]{
            4, 6, 8, 10, 12, 16, 22, 35,
            15, 18, 24, 30, 38, 48, 60, 75
        },
        List.of(
    ...
    CHAPTER1_LEVEL4(1, 4,
        ...
        new int[]{
            4, 6, 8, 12, 16, 20, 28, 45,
            18, 24, 30, 38, 48, 60, 75, 95
        },
        List.of(
    ...
    CHAPTER2_LEVEL4(2, 4,
        ...
        new int[]{
            4, 6, 8, 12, 16, 22, 30, 45,
            20, 26, 34, 45, 58, 75, 100, 130,
            40, 50, 65, 85, 105, 130, 160, 200
        },
        List.of(
            new ObstacleSpawn(ObstacleType.GRAVE, 2, 6)
        )),
    ...
    CHAPTER3_LEVEL4(3, 4,
        ...
        new int[]{
            4, 6, 10, 14, 20, 28, 38, 55,
            25, 32, 42, 55, 70, 90, 115, 145,
            50, 65, 85, 110, 140, 175, 220, 260
        },
        List.of(
    ...
    CHAPTER4_LEVEL3(4, 3,
        ...
        new int[]{
            4, 7, 12, 18, 25, 35, 48, 65,
            30, 40, 52, 68, 88, 112, 145, 180,
            60, 75, 95, 125, 160, 205, 260, 320
        },
        List.of(
    ...
    CHAPTER4_LEVEL4(4, 4,
        ...
        new int[]{
            4, 8, 12, 18, 26, 36, 48, 70,
            35, 45, 58, 75, 95, 120, 150, 195,
            70, 85, 105, 130, 165, 210, 260, 325,
            100, 125, 155, 195, 245, 310, 390, 480
        },
        List.of(
            new ObstacleSpawn(ObstacleType.ARCADE, 2, 8),
            new ObstacleSpawn(ObstacleType.GLACIER, 0, 6),
    ...
    public record ObstacleSpawn(ObstacleType type, int lane, int column) {
    }
}

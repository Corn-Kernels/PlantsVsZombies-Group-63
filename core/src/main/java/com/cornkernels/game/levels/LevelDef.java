...
public enum LevelDef {
    ...
    CHAPTER2_LEVEL1(2, 1,
        ...
        new int[]{6, 7, 8, 12}),
    CHAPTER2_LEVEL2(2, 2,
        List.of(ZombieDef.DEFAULT, ZombieDef.RA),
        new int[]{6, 7, 8, 9, 14}),
    CHAPTER2_LEVEL3(2, 3,
        List.of(ZombieDef.DEFAULT, ZombieDef.RA, ZombieDef.EXPLORER),
        new int[]{6, 8, 9, 10, 16}),
    CHAPTER2_LEVEL4(2, 4,
        List.of(ZombieDef.DEFAULT, ZombieDef.RA, ZombieDef.EXPLORER, ZombieDef.TOMB_RAISER),
        new int[]{7, 8, 10, 11, 18}),

    CHAPTER3_LEVEL1(3, 1,
        List.of(ZombieDef.ARMOR1),
        new int[]{8, 9, 10, 14}),
    CHAPTER3_LEVEL2(3, 2,
        List.of(ZombieDef.ARMOR1, ZombieDef.ICE_AGE_DODO),
        new int[]{8, 10, 11, 16}),
    CHAPTER3_LEVEL3(3, 3,
        List.of(ZombieDef.ARMOR1, ZombieDef.ICE_AGE_DODO, ZombieDef.ICE_AGE_HUNTER),
        new int[]{9, 10, 12, 18}),
    CHAPTER3_LEVEL4(3, 4,
        List.of(ZombieDef.ARMOR1, ZombieDef.ICE_AGE_DODO, ZombieDef.ICE_AGE_HUNTER, ZombieDef.ICE_AGE_TROGLOBITE),
        new int[]{9, 11, 13, 20}),
    ...
    CHAPTER4_LEVEL2(4, 2,
        ...
        new int[]{11, 13, 15, 20}),
    CHAPTER4_LEVEL3(4, 3,
        List.of(ZombieDef.DARK_IMP_DRAGON, ZombieDef.DARK_JUGGLER, ZombieDef.WIZARD),
        new int[]{12, 14, 16, 22}),
    CHAPTER4_LEVEL4(4, 4,
        List.of(ZombieDef.DARK_IMP_DRAGON, ZombieDef.DARK_JUGGLER, ZombieDef.WIZARD, ZombieDef.DARK_KING),

...
public class GrapeshotBehavior implements PlantAttackBehavior {
    ...
    private final float grapeLifetime = 4.0f;
    ...
    public void execute(Entity self, Field field) {
        ...
        if (timer.timeElapsed >= waitTimeSeconds) {
            ...
            field.addProjectile(new AreaOfDamage(origin, aoeRadius, aoeDamage));

            // 2. Calculate speeds and directions
            float speed = 2.0f;
            float diagSpeed = (float) (speed * 0.7071f);
            ...
            Vec2d[] velocities = {
                ...
                new Vec2d(0, -speed),
                new Vec2d(0, speed),
                new Vec2d(-diagSpeed, -diagSpeed),
                new Vec2d(speed, -diagSpeed),
                new Vec2d(-diagSpeed, diagSpeed),
                new Vec2d(speed, diagSpeed)
            };
